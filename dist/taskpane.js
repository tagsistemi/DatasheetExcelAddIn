...
`,Ga=(t,e)=>Pe`
  ...
  outline: calc(${ao} * 1px) solid ${zs};
  outline-offset: calc(${ao} * -1px);
`,el=ze`
  outline: calc(${ao} * 1px) solid ${zs};
  outline-offset: calc(${so} * 1px);
`,il=ze`(${to} + ${io}) * ${oo}`,ol=oi.create("neutral-fill-stealth-rest-on-neutral-fill-layer-rest").withDefault((t=>{const e=Hr.getValueFor(t);return Kr.getValueFor(t).evaluate(t,e.evaluate(t).rest).rest})),nl=oi.create("neutral-fill-stealth-hover-on-neutral-fill-layer-rest").withDefault((t=>{const e=Hr.getValueFor(t);return Kr.getValueFor(t).evaluate(t,e.evaluate(t).rest).hover})),rl=oi.create("neutral-fill-stealth-active-on-neutral-fill-layer-rest").withDefault((t=>{const e=Hr.getValueFor(t);return Kr.getValueFor(t).evaluate(t,e.evaluate(t).rest).active})),sl=(t,e)=>Pe`
    ${Be("flex")} :host {
      box-sizing: border-box;
      ${Ha};
      flex-direction: column;
    ...
    :host(.expanded) .region {
      display: block;
      border-top: calc(${so} * 1px) solid ${Ts};
  ...
  `.withBehaviors(Ja(Pe`
      ...
      `)),al=De.compose({baseName:"accordion-item",template:(t,e)=>ye`
...
`,ml=(t,e,i,o="[disabled]")=>Pe`
  ...
  `.withBehaviors(Ja(Pe`
    ...
    .control:${Xa} {
      box-shadow: 0 0 0 calc(${ao} * 1px) ${Ms} inset !important;
    }
  `.withBehaviors(Ja(Pe`
        .control {
          forced-color-adjust: none;
...
`,styles:Xl}),Ql=Xl,Jl=(t,e)=>Pe`
  ...
  `.withBehaviors(Ja(Pe`
    ...
    <div role="listitem" class="listitem" part="listitem">
        ${zl((t=>t.href&&t.href.length>0),ye`
                ${gl(0,e)}
            `)}
        ${zl((t=>!t.href),ye`
                ${Ce(0,e)}
...
`;class Jc extends yc{constructor(){super(...arguments),this.readonly=!0}}hl([I({converter:C})],Jc.prototype,"readonly",void 0);const Zc=Jc.compose({baseName:"calendar",template:(t,e)=>{var i;const o=new Date,n=`${o.getMonth()+1}-${o.getDate()}-${o.getFullYear()}`;return ye`
        <template>
            ...
            <slot></slot>
            ${zl((t=>!1===t.readonly),Wc(t,n))}
            ${zl((t=>!0===t.readonly),(t=>ye`
...
`.withBehaviors(Ja(Pe`
  ...
  `.withBehaviors(Ja(Pe`
      ...
      `));class xd extends td{cardFillColorChanged(t,e){if(e){const t=Ei(e);null!==t&&(this.neutralPaletteSource=e,tr.setValueFor(this,$i.create(t.r,t.g,t.b)))}}neutralPaletteSourceChanged(t,e){if(e){const t=Ei(e),i=$i.create(t.r,t.g,t.b);Bn.setValueFor(this,Ti.create(i))}}handleChange(t,e){this.cardFillColor||tr.setValueFor(this,(e=>Hr.getValueFor(e).evaluate(e,tr.getValueFor(t)).rest))}connectedCallback(){super.connectedCallback();const t=Me(this);if(t){const e=b.getNotifier(t);e.subscribe(this,"fillColor"),e.subscribe(this,"neutralPalette"),this.handleChange(t,"fillColor")}}}hl([I({attribute:"card-fill-color",mode:"fromView"})],xd.prototype,"cardFillColor",void 0),hl([I({attribute:"neutral-palette-source",mode:"fromView"})],xd.prototype,"neutralPaletteSource",void 0);const wd=xd.compose({baseName:"card",baseClass:td,template:(t,e)=>ye`
    <slot></slot>
`,styles:yd}),$d=yd;class kd extends _t{}class Cd extends(sc(kd)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}class Fd extends Cd{constructor(){super(),this.initialValue="on",this.indeterminate=!1,this.keypressHandler=t=>{this.readOnly||t.key!==H||(this.indeterminate&&(this.indeterminate=!1),this.checked=!this.checked)},this.clickHandler=t=>{this.disabled||this.readOnly||(this.indeterminate&&(this.indeterminate=!1),this.checked=!this.checked)},this.proxy.setAttribute("type","checkbox")}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly)}}o([I({attribute:"readonly",mode:"boolean"})],Fd.prototype,"readOnly",void 0),o([y],Fd.prototype,"defaultSlottedNodes",void 0),o([y],Fd.prototype,"indeterminate",void 0);const Sd=(t,e)=>Pe`
    ${Be("inline-flex")} :host {
      align-items: center;
      outline: none;
      ${""} user-select: none;
...
`,Qd=".control",Jd=":not([disabled]):not([open])",Zd="[disabled]",th=(t,e)=>Pe`
  ...
  `.withBehaviors(Cl("outline",Kd(t,e,ih,oh)),Cl("filled",Xd(t,e,ih,oh)),Ja(Yd(t,e,ih,oh)));class rh extends Md{appearanceChanged(t,e){t!==e&&(this.classList.add(e),this.classList.remove(t))}connectedCallback(){super.connectedCallback(),this.appearance||(this.appearance="outline"),this.listbox&&tr.setValueFor(this.listbox,qn)}}hl([I({mode:"fromView"})],rh.prototype,"appearance",void 0);const sh=rh.compose({baseName:"combobox",baseClass:Md,shadowOptions:{delegatesFocus:!0},template:(t,e)=>ye`
    <template
        aria-disabled="${t=>t.ariaDisabled}"
...
`,zh=Ph.compose({baseName:"dialog",template:(t,e)=>ye`
...
`,styles:Hh}),Bh=Hh,Mh="horizontal",Nh="vertical";class jh extends _t{constructor(){super(...arguments),this.role="separator",this.orientation=Mh}}o([I],jh.prototype,"role",void 0),o([I],jh.prototype,"orientation",void 0);const Uh=(t,e)=>Pe`
    ${Be("block")} :host {
...
`,styles:ku,checkboxIndicator:'\n    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">\n      <path d="M13.86 3.66a.5.5 0 01-.02.7l-7.93 7.48a.6.6 0 01-.84-.02L2.4 9.1a.5.5 0 01.72-.7l2.4 2.44 7.65-7.2a.5.5 0 01.7.02z"/>\n    </svg>\n  ',expandCollapseGlyph:'\n    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">\n      <path d="M5.65 3.15a.5.5 0 000 .7L9.79 8l-4.14 4.15a.5.5 0 00.7.7l4.5-4.5a.5.5 0 000-.7l-4.5-4.5a.5.5 0 00-.7 0z"/>\n    </svg>\n  ',radioIndicator:'\n    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">\n      <circle cx="8" cy="8" r="2"/>\n    </svg>\n  '}),Fu=ku;class Su extends _t{}class Iu extends(rc(Su)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}class Du extends Iu{constructor(){super(...arguments),this.type="text"}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly,this.validate())}autofocusChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.autofocus=this.autofocus,this.validate())}placeholderChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.placeholder=this.placeholder)}typeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.type=this.type,this.validate())}listChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.setAttribute("list",this.list),this.validate())}maxlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.maxLength=this.maxlength,this.validate())}minlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.minLength=this.minlength,this.validate())}patternChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.pattern=this.pattern,this.validate())}sizeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.size=this.size)}spellcheckChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.spellcheck=this.spellcheck)}connectedCallback(){super.connectedCallback(),this.proxy.setAttribute("type",this.type),this.validate(),this.autofocus&&g.queueUpdate((()=>{this.focus()}))}select(){this.control.select(),this.$emit("select")}handleTextInput(){this.value=this.control.value}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}o([I({attribute:"readonly",mode:"boolean"})],Du.prototype,"readOnly",void 0),o([I({mode:"boolean"})],Du.prototype,"autofocus",void 0),o([I],Du.prototype,"placeholder",void 0),o([I],Du.prototype,"type",void 0),o([I],Du.prototype,"list",void 0),o([I({converter:F})],Du.prototype,"maxlength",void 0),o([I({converter:F})],Du.prototype,"minlength",void 0),o([I],Du.prototype,"pattern",void 0),o([I({converter:F})],Du.prototype,"size",void 0),o([I({mode:"boolean"})],Du.prototype,"spellcheck",void 0),o([y],Du.prototype,"defaultSlottedNodes",void 0);class Tu{}Ie(Tu,ul),Ie(Du,$e,Tu);class Ru extends _t{}class Ou extends(rc(Ru)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}class Eu extends Ou{constructor(){super(...arguments),this.hideStep=!1,this.step=1,this.isUserInput=!1}maxChanged(t,e){var i;this.max=Math.max(e,null!==(i=this.min)&&void 0!==i?i:e);const o=Math.min(this.min,this.max);void 0!==this.min&&this.min!==o&&(this.min=o),this.value=this.getValidValue(this.value)}minChanged(t,e){var i;this.min=Math.min(e,null!==(i=this.max)&&void 0!==i?i:e);const o=Math.max(this.min,this.max);void 0!==this.max&&this.max!==o&&(this.max=o),this.value=this.getValidValue(this.value)}get valueAsNumber(){return parseFloat(super.value)}set valueAsNumber(t){this.value=t.toString()}valueChanged(t,e){this.value=this.getValidValue(e),e===this.value&&(this.control&&!this.isUserInput&&(this.control.value=this.value),super.valueChanged(t,this.value),void 0===t||this.isUserInput||(this.$emit("input"),this.$emit("change")),this.isUserInput=!1)}validate(){super.validate(this.control)}getValidValue(t){var e,i;let o=parseFloat(parseFloat(t).toPrecision(12));return isNaN(o)?o="":(o=Math.min(o,null!==(e=this.max)&&void 0!==e?e:o),o=Math.max(o,null!==(i=this.min)&&void 0!==i?i:o).toString()),o}stepUp(){const t=parseFloat(this.value),e=isNaN(t)?this.min>0?this.min:this.max<0?this.max:this.min?0:this.step:t+this.step;this.value=e.toString()}stepDown(){const t=parseFloat(this.value),e=isNaN(t)?this.min>0?this.min:this.max<0?this.max:this.min?0:0-this.step:t-this.step;this.value=e.toString()}connectedCallback(){super.connectedCallback(),this.proxy.setAttribute("type","number"),this.validate(),this.control.value=this.value,this.autofocus&&g.queueUpdate((()=>{this.focus()}))}select(){this.control.select(),this.$emit("select")}handleTextInput(){this.control.value=this.control.value.replace(/[^0-9\-+e.]/g,""),this.isUserInput=!0,this.value=this.control.value}handleChange(){this.$emit("change")}handleKeyDown(t){switch(t.key){case E:return this.stepUp(),!1;case T:return this.stepDown(),!1}return!0}handleBlur(){this.control.value=this.value}}o([I({attribute:"readonly",mode:"boolean"})],Eu.prototype,"readOnly",void 0),o([I({mode:"boolean"})],Eu.prototype,"autofocus",void 0),o([I({attribute:"hide-step",mode:"boolean"})],Eu.prototype,"hideStep",void 0),o([I],Eu.prototype,"placeholder",void 0),o([I],Eu.prototype,"list",void 0),o([I({converter:F})],Eu.prototype,"maxlength",void 0),o([I({converter:F})],Eu.prototype,"minlength",void 0),o([I({converter:F})],Eu.prototype,"size",void 0),o([I({converter:F})],Eu.prototype,"step",void 0),o([I({converter:F})],Eu.prototype,"max",void 0),o([I({converter:F})],Eu.prototype,"min",void 0),o([y],Eu.prototype,"defaultSlottedNodes",void 0),Ie(Eu,$e,Tu);const Au=".root",Lu=(t,e)=>Pe`
    ${Be("inline-block")}
  ...
  `.withBehaviors(Cl("outline",Kd(t,e,Au)),Cl("filled",Xd(t,e,Au)),Ja(Yd(t,e,Au)));class Vu extends Eu{connectedCallback(){super.connectedCallback(),this.appearance||(this.appearance="outline")}}hl([I],Vu.prototype,"appearance",void 0);const Pu=Lu,Hu=Vu.compose({baseName:"number-field",baseClass:Eu,styles:Lu,template:(t,e)=>ye`
    <template class="${t=>t.readOnly?"readonly":""}">
        ...
        <div class="root" part="root">
            ...
            <input
                ...
                ${we("control")}
            />
            ${zl((t=>!t.hideStep&&!t.readOnly&&!t.disabled),ye`
...
`,shadowOptions:{delegatesFocus:!0},stepDownGlyph:'\n    <svg width="12" height="12" xmlns="http://www.w3.org/2000/svg">\n      <path d="M2.15 4.65c.2-.2.5-.2.7 0L6 7.79l3.15-3.14a.5.5 0 11.7.7l-3.5 3.5a.5.5 0 01-.7 0l-3.5-3.5a.5.5 0 010-.7z"/>\n    </svg>\n  ',stepUpGlyph:'\n    <svg width="12" height="12" xmlns="http://www.w3.org/2000/svg">\n      <path d="M2.15 7.35c.2.2.5.2.7 0L6 4.21l3.15 3.14a.5.5 0 10.7-.7l-3.5-3.5a.5.5 0 00-.7 0l-3.5 3.5a.5.5 0 000 .7z"/>\n    </svg>\n'});class zu extends _t{constructor(){super(...arguments),this.percentComplete=0}valueChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}minChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}maxChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}connectedCallback(){super.connectedCallback(),this.updatePercentComplete()}updatePercentComplete(){const t="number"==typeof this.min?this.min:0,e="number"==typeof this.max?this.max:100,i="number"==typeof this.value?this.value:0,o=e-t;this.percentComplete=0===o?0:Math.fround((i-t)/o*100)}}o([I({converter:F})],zu.prototype,"value",void 0),o([I({converter:F})],zu.prototype,"min",void 0),o([I({converter:F})],zu.prototype,"max",void 0),o([I({mode:"boolean"})],zu.prototype,"paused",void 0),o([y],zu.prototype,"percentComplete",void 0);const Bu=(t,e)=>Pe`
    ${Be("flex")} :host {
      align-items: center;
  ...
  `.withBehaviors(Ja(Pe`
      ...
      `));class Mu extends zu{}const Nu=Mu.compose({baseName:"progress",template:(t,e)=>ye`
    <template
        role="progressbar"
...
`,styles:Bu,indeterminateIndicator1:'\n    <span class="indeterminate-indicator-1" part="indeterminate-indicator-1"></span>\n  ',indeterminateIndicator2:'\n    <span class="indeterminate-indicator-2" part="indeterminate-indicator-2"></span>\n  '}),ju=Bu,Uu=(t,e)=>Pe`
    ${Be("flex")} :host {
      align-items: center;
      height: calc(${il} * 1px);
      width: calc(${il} * 1px);
  ...
  `.withBehaviors(Ja(Pe`
      ...
      `));class _u extends zu{}const qu=_u.compose({baseName:"progress-ring",template:(t,e)=>ye`
    <template
        role="progressbar"
        aria-valuenow="${t=>t.value}"
        aria-valuemin="${t=>t.min}"
...
`,ep=Zu.compose({baseName:"radio-group",template:(t,e)=>ye`
    ...
    >
        ...
        <div
            class="positioning-region ${t=>t.orientation===Mh?"horizontal":"vertical"}"
...
`,styles:Cp}),Sp=Cp;function Ip(t,e,i,o){let n=N(0,1,(t-e)/(i-e));return o===ni.rtl&&(n=1-n),n}class Dp extends _t{}class Tp extends(rc(Dp)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}class Rp extends Tp{constructor(){super(...arguments),this.direction=ni.ltr,this.isDragging=!1,this.trackWidth=0,this.trackMinWidth=0,this.trackHeight=0,this.trackLeft=0,this.trackMinHeight=0,this.valueTextFormatter=()=>null,this.min=0,this.max=10,this.step=1,this.orientation=Mh,this.mode="single-value",this.keypressHandler=t=>{if(!this.readOnly)if(t.key===V)t.preventDefault(),this.value=`${this.min}`;else if(t.key===P)t.preventDefault(),this.value=`${this.max}`;else if(!t.shiftKey)switch(t.key){case O:case E:t.preventDefault(),this.increment();break;case R:case T:t.preventDefault(),this.decrement()}},this.setupTrackConstraints=()=>{const t=this.track.getBoundingClientRect();this.trackWidth=this.track.clientWidth,this.trackMinWidth=this.track.clientLeft,this.trackHeight=t.bottom,this.trackMinHeight=t.top,this.trackLeft=this.getBoundingClientRect().left,0===this.trackWidth&&(this.trackWidth=1)},this.setupListeners=(t=!1)=>{const e=(t?"remove":"add")+"EventListener";this[e]("keydown",this.keypressHandler),this[e]("mousedown",this.handleMouseDown),this.thumb[e]("mousedown",this.handleThumbMouseDown,{passive:!0}),this.thumb[e]("touchstart",this.handleThumbMouseDown,{passive:!0}),t&&(this.handleMouseDown(null),this.handleThumbMouseDown(null))},this.initialValue="",this.handleThumbMouseDown=t=>{if(t){if(this.readOnly||this.disabled||t.defaultPrevented)return;t.target.focus()}const e=(null!==t?"add":"remove")+"EventListener";window[e]("mouseup",this.handleWindowMouseUp),window[e]("mousemove",this.handleMouseMove,{passive:!0}),window[e]("touchmove",this.handleMouseMove,{passive:!0}),window[e]("touchend",this.handleWindowMouseUp),this.isDragging=null!==t},this.handleMouseMove=t=>{if(this.readOnly||this.disabled||t.defaultPrevented)return;const e=window.TouchEvent&&t instanceof TouchEvent?t.touches[0]:t,i=this.orientation===Mh?e.pageX-document.documentElement.scrollLeft-this.trackLeft:e.pageY-document.documentElement.scrollTop;this.value=`${this.calculateNewValue(i)}`},this.calculateNewValue=t=>{const e=Ip(t,this.orientation===Mh?this.trackMinWidth:this.trackMinHeight,this.orientation===Mh?this.trackWidth:this.trackHeight,this.direction),i=(this.max-this.min)*e+this.min;return this.convertToConstrainedValue(i)},this.handleWindowMouseUp=t=>{this.stopDragging()},this.stopDragging=()=>{this.isDragging=!1,this.handleMouseDown(null),this.handleThumbMouseDown(null)},this.handleMouseDown=t=>{const e=(null!==t?"add":"remove")+"EventListener";if((null===t||!this.disabled&&!this.readOnly)&&(window[e]("mouseup",this.handleWindowMouseUp),window.document[e]("mouseleave",this.handleWindowMouseUp),window[e]("mousemove",this.handleMouseMove),t)){t.preventDefault(),this.setupTrackConstraints(),t.target.focus();const e=this.orientation===Mh?t.pageX-document.documentElement.scrollLeft-this.trackLeft:t.pageY-document.documentElement.scrollTop;this.value=`${this.calculateNewValue(e)}`}},this.convertToConstrainedValue=t=>{isNaN(t)&&(t=this.min);let e=t-this.min;const i=e-Math.round(e/this.step)*(this.stepMultiplier*this.step)/this.stepMultiplier;return e=i>=Number(this.step)/2?e-i+Number(this.step):e-i,e+this.min}}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly)}get valueAsNumber(){return parseFloat(super.value)}set valueAsNumber(t){this.value=t.toString()}valueChanged(t,e){super.valueChanged(t,e),this.$fastController.isConnected&&this.setThumbPositionForOrientation(this.direction),this.$emit("change")}minChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.min=`${this.min}`),this.validate()}maxChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.max=`${this.max}`),this.validate()}stepChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.step=`${this.step}`),this.updateStepMultiplier(),this.validate()}orientationChanged(){this.$fastController.isConnected&&this.setThumbPositionForOrientation(this.direction)}connectedCallback(){super.connectedCallback(),this.proxy.setAttribute("type","range"),this.direction=Pl(this),this.updateStepMultiplier(),this.setupTrackConstraints(),this.setupListeners(),this.setupDefaultValue(),this.setThumbPositionForOrientation(this.direction)}disconnectedCallback(){this.setupListeners(!0)}increment(){const t=this.direction!==ni.rtl&&this.orientation!==Nh?Number(this.value)+Number(this.step):Number(this.value)-Number(this.step),e=this.convertToConstrainedValue(t),i=e<Number(this.max)?`${e}`:`${this.max}`;this.value=i}decrement(){const t=this.direction!==ni.rtl&&this.orientation!==Nh?Number(this.value)-Number(this.step):Number(this.value)+Number(this.step),e=this.convertToConstrainedValue(t),i=e>Number(this.min)?`${e}`:`${this.min}`;this.value=i}setThumbPositionForOrientation(t){const e=100*(1-Ip(Number(this.value),Number(this.min),Number(this.max),t));this.orientation===Mh?this.position=this.isDragging?`right: ${e}%; transition: none;`:`right: ${e}%; transition: all 0.2s ease;`:this.position=this.isDragging?`bottom: ${e}%; transition: none;`:`bottom: ${e}%; transition: all 0.2s ease;`}updateStepMultiplier(){const t=this.step+"",e=this.step%1?t.length-t.indexOf(".")-1:0;this.stepMultiplier=Math.pow(10,e)}get midpoint(){return`${this.convertToConstrainedValue((this.max+this.min)/2)}`}setupDefaultValue(){if("string"==typeof this.value)if(0===this.value.length)this.initialValue=this.midpoint;else{const t=parseFloat(this.value);!Number.isNaN(t)&&(t<this.min||t>this.max)&&(this.value=this.midpoint)}}}o([I({attribute:"readonly",mode:"boolean"})],Rp.prototype,"readOnly",void 0),o([y],Rp.prototype,"direction",void 0),o([y],Rp.prototype,"isDragging",void 0),o([y],Rp.prototype,"position",void 0),o([y],Rp.prototype,"trackWidth",void 0),o([y],Rp.prototype,"trackMinWidth",void 0),o([y],Rp.prototype,"trackHeight",void 0),o([y],Rp.prototype,"trackLeft",void 0),o([y],Rp.prototype,"trackMinHeight",void 0),o([y],Rp.prototype,"valueTextFormatter",void 0),o([I({converter:F})],Rp.prototype,"min",void 0),o([I({converter:F})],Rp.prototype,"max",void 0),o([I({converter:F})],Rp.prototype,"step",void 0),o([I],Rp.prototype,"orientation",void 0),o([I],Rp.prototype,"mode",void 0);const Op=(t,e)=>Pe`
    ${Be("inline-grid")} :host {
    ...
    :host(:${Xa}) .thumb-cursor {
      box-shadow: 0 0 0 2px ${tr}, 0 0 0 4px ${zs};
    }
    .thumb-container {
      position: absolute;
...
`,styles:Op,thumb:'\n    <div class="thumb-cursor"></div>\n  '}),Ap=Op,Lp={min:0,max:0,direction:ni.ltr,orientation:Mh,disabled:!1};class Vp extends _t{constructor(){super(...arguments),this.hideMark=!1,this.sliderDirection=ni.ltr,this.getSliderConfiguration=()=>{if(this.isSliderConfig(this.parentNode)){const t=this.parentNode,{min:e,max:i,direction:o,orientation:n,disabled:r}=t;void 0!==r&&(this.disabled=r),this.sliderDirection=o||ni.ltr,this.sliderOrientation=n||Mh,this.sliderMaxPosition=i,this.sliderMinPosition=e}else this.sliderDirection=Lp.direction||ni.ltr,this.sliderOrientation=Lp.orientation||Mh,this.sliderMaxPosition=Lp.max,this.sliderMinPosition=Lp.min},this.positionAsStyle=()=>{const t=this.sliderDirection?this.sliderDirection:ni.ltr,e=Ip(Number(this.position),Number(this.sliderMinPosition),Number(this.sliderMaxPosition));let i=Math.round(100*(1-e)),o=Math.round(100*e);return Number.isNaN(o)&&Number.isNaN(i)&&(i=50,o=50),this.sliderOrientation===Mh?t===ni.rtl?`right: ${o}%; left: ${i}%;`:`left: ${o}%; right: ${i}%;`:`top: ${o}%; bottom: ${i}%;`}}positionChanged(){this.positionStyle=this.positionAsStyle()}sliderOrientationChanged(){}connectedCallback(){super.connectedCallback(),this.getSliderConfiguration(),this.positionStyle=this.positionAsStyle(),this.notifier=b.getNotifier(this.parentNode),this.notifier.subscribe(this,"orientation"),this.notifier.subscribe(this,"direction"),this.notifier.subscribe(this,"max"),this.notifier.subscribe(this,"min")}disconnectedCallback(){super.disconnectedCallback(),this.notifier.unsubscribe(this,"orientation"),this.notifier.unsubscribe(this,"direction"),this.notifier.unsubscribe(this,"max"),this.notifier.unsubscribe(this,"min")}handleChange(t,e){switch(e){case"direction":this.sliderDirection=t.direction;break;case"orientation":this.sliderOrientation=t.orientation;break;case"max":this.sliderMaxPosition=t.max;break;case"min":this.sliderMinPosition=t.min}this.positionStyle=this.positionAsStyle()}isSliderConfig(t){return void 0!==t.max&&void 0!==t.min}}o([y],Vp.prototype,"positionStyle",void 0),o([I],Vp.prototype,"position",void 0),o([I({attribute:"hide-mark",mode:"boolean"})],Vp.prototype,"hideMark",void 0),o([I({attribute:"disabled",mode:"boolean"})],Vp.prototype,"disabled",void 0),o([y],Vp.prototype,"sliderOrientation",void 0),o([y],Vp.prototype,"sliderMinPosition",void 0),o([y],Vp.prototype,"sliderMaxPosition",void 0),o([y],Vp.prototype,"sliderDirection",void 0);const Pp=(t,e)=>Pe`
  ...
  `.withBehaviors(Ja(Pe`
      ...
      `)),Hp=Vp.compose({baseName:"slider-label",template:(t,e)=>ye`
    <template
        aria-disabled="${t=>t.disabled}"
        class="${t=>t.sliderOrientation||Mh}
...
`,styles:Pp}),zp=Pp;class Bp extends _t{}class Mp extends(sc(Bp)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}class Np extends Mp{constructor(){super(),this.initialValue="on",this.keypressHandler=t=>{if(!this.readOnly)switch(t.key){case A:case H:this.checked=!this.checked}},this.clickHandler=t=>{this.disabled||this.readOnly||(this.checked=!this.checked)},this.proxy.setAttribute("type","checkbox")}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly),this.readOnly?this.classList.add("readonly"):this.classList.remove("readonly")}checkedChanged(t,e){super.checkedChanged(t,e),this.checked?this.classList.add("checked"):this.classList.remove("checked")}}o([I({attribute:"readonly",mode:"boolean"})],Np.prototype,"readOnly",void 0),o([y],Np.prototype,"defaultSlottedNodes",void 0);const jp=(t,e)=>Pe`
    :host([hidden]) {
      display: none;
    }
...
`,styles:df,shadowOptions:{delegatesFocus:!0}}),pf=df,ff=".root",gf=(t,e)=>Pe`
  ...
  `.withBehaviors(Cl("outline",Kd(t,e,ff)),Cl("filled",Xd(t,e,ff)),Ja(Yd(t,e,ff)));class mf extends Du{appearanceChanged(t,e){t!==e&&(this.classList.add(e),this.classList.remove(t))}connectedCallback(){super.connectedCallback(),this.appearance||(this.appearance="outline")}}hl([I],mf.prototype,"appearance",void 0);const vf=mf.compose({baseName:"text-field",baseClass:Du,template:(t,e)=>ye`
    <template
        class="
            ${t=>t.readOnly?"readonly":""}
        "
...
`,styles:(t,e)=>Pe`
  ...
  `.withBehaviors(Ja(Pe`
    ...
    ${t.tagFor(Hl)}.top .tooltip::after,
    ${t.tagFor(Hl)}.bottom .tooltip::after,
    ${t.tagFor(Hl)}.left .tooltip::after,
    ${t.tagFor(Hl)}.right .tooltip::after {
      content: '';
      width: 12px;
      height: 12px;
      background: ${tr};
      border-top: calc(${so} * 1px) solid ${Ts};
      border-left: calc(${so} * 1px) solid ${Ts};
      position: absolute;
    }
  ...
  `.withBehaviors(Ja(Pe`
      ...
      `))});function If(t){return Wa(t)&&"treeitem"===t.getAttribute("role")}class Df extends _t{constructor(){super(...arguments),this.expanded=!1,this.focusable=!1,this.isNestedItem=()=>If(this.parentElement),this.handleExpandCollapseButtonClick=t=>{this.disabled||t.defaultPrevented||(this.expanded=!this.expanded)},this.handleFocus=t=>{this.setAttribute("tabindex","0")},this.handleBlur=t=>{this.setAttribute("tabindex","-1")}}expandedChanged(){this.$fastController.isConnected&&this.$emit("expanded-change",this)}selectedChanged(){this.$fastController.isConnected&&this.$emit("selected-change",this)}itemsChanged(t,e){this.$fastController.isConnected&&this.items.forEach((t=>{If(t)&&(t.nested=!0)}))}static focusItem(t){t.focusable=!0,t.focus()}childItemLength(){const t=this.childItems.filter((t=>If(t)));return t?t.length:0}}o([I({mode:"boolean"})],Df.prototype,"expanded",void 0),o([I({mode:"boolean"})],Df.prototype,"selected",void 0),o([I({mode:"boolean"})],Df.prototype,"disabled",void 0),o([y],Df.prototype,"focusable",void 0),o([y],Df.prototype,"childItems",void 0),o([y],Df.prototype,"items",void 0),o([y],Df.prototype,"nested",void 0),o([y],Df.prototype,"renderCollapsedChildren",void 0),Ie(Df,$e);class Tf extends _t{constructor(){super(...arguments),this.currentFocused=null,this.handleFocus=t=>{if(!(this.slottedTreeItems.length<1))return t.target===this?(null===this.currentFocused&&(this.currentFocused=this.getValidFocusableItem()),void(null!==this.currentFocused&&Df.focusItem(this.currentFocused))):void(this.contains(t.target)&&(this.setAttribute("tabindex","-1"),this.currentFocused=t.target))},this.handleBlur=t=>{t.target instanceof HTMLElement&&(null===t.relatedTarget||!this.contains(t.relatedTarget))&&this.setAttribute("tabindex","0")},this.handleKeyDown=t=>{if(t.defaultPrevented)return;if(this.slottedTreeItems.length<1)return!0;const e=this.getVisibleNodes();switch(t.key){case V:return void(e.length&&Df.focusItem(e[0]));case P:return void(e.length&&Df.focusItem(e[e.length-1]));case R:if(t.target&&this.isFocusableElement(t.target)){const e=t.target;e instanceof Df&&e.childItemLength()>0&&e.expanded?e.expanded=!1:e instanceof Df&&e.parentElement instanceof Df&&Df.focusItem(e.parentElement)}return!1;case O:if(t.target&&this.isFocusableElement(t.target)){const e=t.target;e instanceof Df&&e.childItemLength()>0&&!e.expanded?e.expanded=!0:e instanceof Df&&e.childItemLength()>0&&this.focusNextNode(1,t.target)}return;case T:return void(t.target&&this.isFocusableElement(t.target)&&this.focusNextNode(1,t.target));case E:return void(t.target&&this.isFocusableElement(t.target)&&this.focusNextNode(-1,t.target));case A:return void this.handleClick(t)}return!0},this.handleSelectedChange=t=>{if(t.defaultPrevented)return;if(!(t.target instanceof Element&&If(t.target)))return!0;const e=t.target;e.selected?(this.currentSelected&&this.currentSelected!==e&&(this.currentSelected.selected=!1),this.currentSelected=e):e.selected||this.currentSelected!==e||(this.currentSelected=null)},this.setItems=()=>{const t=this.treeView.querySelector("[aria-selected='true']");this.currentSelected=t,null!==this.currentFocused&&this.contains(this.currentFocused)||(this.currentFocused=this.getValidFocusableItem()),this.nested=this.checkForNestedItems(),this.getVisibleNodes().forEach((t=>{If(t)&&(t.nested=this.nested)}))},this.isFocusableElement=t=>If(t),this.isSelectedElement=t=>t.selected}slottedTreeItemsChanged(){this.$fastController.isConnected&&this.setItems()}connectedCallback(){super.connectedCallback(),this.setAttribute("tabindex","0"),g.queueUpdate((()=>{this.setItems()}))}handleClick(t){if(t.defaultPrevented)return;if(!(t.target instanceof Element&&If(t.target)))return!0;const e=t.target;e.disabled||(e.selected=!e.selected)}focusNextNode(t,e){const i=this.getVisibleNodes();if(!i)return;const o=i[i.indexOf(e)+t];Wa(o)&&Df.focusItem(o)}getValidFocusableItem(){const t=this.getVisibleNodes();let e=t.findIndex(this.isSelectedElement);return-1===e&&(e=t.findIndex(this.isFocusableElement)),-1!==e?t[e]:null}checkForNestedItems(){return this.slottedTreeItems.some((t=>If(t)&&t.querySelector("[role='treeitem']")))}getVisibleNodes(){return function(t,e){if(t&&Wa(t))return Array.from(t.querySelectorAll(e)).filter((t=>null!==t.offsetParent))}(this,"[role='treeitem']")||[]}}o([I({attribute:"render-collapsed-nodes"})],Tf.prototype,"renderCollapsedNodes",void 0),o([y],Tf.prototype,"currentSelected",void 0),o([y],Tf.prototype,"slottedTreeItems",void 0);const Rf=(t,e)=>Pe`
  :host([hidden]) {
    display: none;
  }
...
`,Of=Tf.compose({baseName:"tree-view",template:(t,e)=>ye`
    <template
        role="tree"
        ${we("treeView")}
        @keydown="${(t,e)=>t.handleKeyDown(e.event)}"
...
`,Vf=ze`((${to} / 2) * ${oo}) + ((${oo} * ${io}) / 2)`,Pf=oi.create("tree-item-expand-collapse-hover").withDefault((t=>{const e=Kr.getValueFor(t);return e.evaluate(t,e.evaluate(t).hover).hover})),Hf=oi.create("tree-item-expand-collapse-selected-hover").withDefault((t=>{const e=Ur.getValueFor(t);return Kr.getValueFor(t).evaluate(t,e.evaluate(t).rest).hover})),zf=(t,e)=>Pe`
    ${Be("block")} :host {
      contain: content;
      position: relative;
      outline: none;
  ...
  `.withBehaviors(new Kc(Af,Lf),Ja(Pe`
      ...
      `)),Bf=Df.compose({baseName:"tree-item",template:(t,e)=>ye`
    <template
        role="treeitem"
    ...
    >
        <div class="positioning-region" part="positioning-region">
            <div class="content-region" part="content-region">
                ${zl((t=>t.childItems&&t.childItemLength()>0),ye`
                        <div
                            aria-hidden="true"
